...
import com.hos.base.handler.IFillRuleHandler;
...
public class FillRuleUtil {
    ...
    public static Object executeRule(String ruleCode, JSONObject formData) {
        if (!ToolUtil.isEmpty(ruleCode)) {
            try {
                // 获取 Service
                ServiceImpl impl = (ServiceImpl) SpringContextHolder.getBean("sysFillRuleServiceImpl");
                // 根据 ruleCode 查询出实体
