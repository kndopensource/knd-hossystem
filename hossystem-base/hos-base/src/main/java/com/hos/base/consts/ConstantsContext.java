package com.hos.base.consts;

import com.hos.base.enums.CommonStatus;
import com.hos.base.sms.AliyunSmsProperties;
...
public class ConstantsContext {
    ...
    public static String getSystemName() {
        ...
        if (ToolUtil.isEmpty(systemName)) {
            log.error("系统常量存在空值！常量名称：GUNS_SYSTEM_NAME，采用默认名称：Hos快速开发平台" + TIPS_END);
            return "Knd.Hos快速开发平台";
        } else {
            return systemName;
        }
    }
