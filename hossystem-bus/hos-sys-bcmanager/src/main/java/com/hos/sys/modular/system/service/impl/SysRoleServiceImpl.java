...
import com.hos.sys.core.util.PmsUtil;
import com.hos.sys.modular.system.entity.SysRole;
import com.hos.sys.modular.system.mapper.SysRoleMapper;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements ISysRoleService {
    ...
    @Override
    public ResponseData importExcelCheckRoleCode(MultipartFile file, ImportParams params) throws Exception {
        ...
        if (errorStrs.size() == 0) {
            return ResponseData.success("文件导入成功！总导入行数：" + totalCount);
        }
