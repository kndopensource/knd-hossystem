...
import com.hos.sys.modular.system.mapper.SysPermissionMapper;
import com.hos.sys.modular.system.model.TreeModel;
import com.hos.sys.modular.system.service.ISysPermissionDataRuleService;
import com.hos.sys.modular.system.service.ISysPermissionService;
...
//	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void deletePermission(String id) throws ServiceException {
		...
		if(sysPermission==null) {
			throw new ServiceException(404,"未找到菜单信息");
		}
...
//	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	...
	@Override
//	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void addPermission(SysPermission sysPermission) throws ServiceException {
		//----------------------------------------------------------------------
		//判断是否是一级菜单，是的话清空父菜单
	...
	@Override
//	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void editPermission(SysPermission sysPermission) throws ServiceException {
