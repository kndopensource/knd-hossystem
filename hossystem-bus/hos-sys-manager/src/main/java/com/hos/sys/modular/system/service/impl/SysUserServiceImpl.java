...
import com.hos.sys.modular.system.mapper.SysDepartMapper;
import com.hos.sys.modular.system.mapper.SysUserDepartMapper;
import com.hos.sys.modular.system.mapper.SysUserMapper;
import com.hos.sys.modular.system.model.SysUserSysDepartModel;
import com.hos.sys.modular.system.service.ISysUserService;
import com.hos.sys.modular.system.vo.SysUserCacheInfo;
import com.hos.sys.modular.system.vo.SysUserDepVo;
...
//    @CacheEvict(value = {CacheConstant.SYS_USERS_CACHE}, allEntries = true)
    public ResponseData resetPassword(String username, String oldpassword, String newpassword, String confirmpassword) {
        ...
        if (oConvertUtils.isEmpty(newpassword)) {
            return ResponseData.error("新密码不允许为空!");
        }
        if (!newpassword.equals(confirmpassword)) {
            return ResponseData.error("两次输入密码不一致!");
        }
    ...
    @Override
//    @CacheEvict(value = {CacheConstant.SYS_USERS_CACHE}, allEntries = true)
    public ResponseData changePassword(SysUser sysUser) {
